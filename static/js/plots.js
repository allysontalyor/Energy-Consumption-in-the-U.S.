...
var data3 = [{
  ...
  colorscale: [
      ...
      [0, 'rgb(242, 248, 252)'], [0.2, 'rgb(184, 206, 227)'],
      [0.4, 'rgb(73, 132, 184)'], [0.6, 'rgb(52, 108, 158)'],
      [0.8, 'rgb(11, 51, 87)'], [1, 'rgb(3, 28, 51)']
  ],
  colorbar: {
      title: 'Percentage of Total Energy',
      font: {
...
var data = [{
  values: [12,23,7,2,56],
  labels: ['Transportation', 'Industrial', 'Residential','Commercial','Electrical Power'],
  type: 'pie',
  marker: {
    colors: ["#7DCEA0","#1A5276","#5499C7","#A3E4D7","#16A085"]
  }
}];
...
var layout = {
  ...
  width: 425,
  title: {
    text: 'Renewable Energy by Sector 2017',
    font: {
      family: 'Courier New, monospace',
      size: 20,
    },
